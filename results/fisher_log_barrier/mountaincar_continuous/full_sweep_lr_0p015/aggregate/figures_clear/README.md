...
- A value of `+1` means a 10x improvement; `+2` means 100x.
- Raw endpoint dots show individual seeds; black bars show means.
- `n=4` marks beta=1e-4 after its seed-103 strict-domain failure.
